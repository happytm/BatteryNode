...
//std::string sensorType1; std::string sensorType2; std::string sensorType3; std::string sensorType4;
...
//   ============= Client Publish ================
    ...
    client1.publish(sentTopic, sentPayload);
    Serial << "Client " << sentPayload.c_str() << endl;

    client1.publish(sentTopic, std::string(String(millis()).c_str()));
    Serial << "Client1 published to topic " << sentTopic.c_str() << " with payload " << std::string(String(millis()).c_str()) << endl;
    */
} // End of Loop
