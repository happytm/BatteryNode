...
void setup() {
  ...
  if (EEPROM.readByte(0) == 255)  {EEPROM.writeByte(0, 246);}      // Device ID
  if (EEPROM.readByte(14) == 255) {EEPROM.writeByte(14, 7);}       // AP Channel
  if (EEPROM.readByte(15) == 255 || EEPROM.readByte(15) == 1) {EEPROM.writeByte(15, 0);}       // Device mode. 0 = Normal mode & 1 = OTA update mode
