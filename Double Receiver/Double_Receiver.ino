...
char messageTostations[32] = "Gateway";  //Here we can use Sring/char* type variable of maximum of 32 characters.https://arduino-esp8266.readthedocs.io/en/latest/esp8266wifi/station-class.html
...
//============================IR Repeater Loop starts=================================
   ...
   for(int i=0; i<availableBytes; i++)
{
   messageTostations[i] = Serial.read();
   messageTostations[i+1] = '\0'; // Append a null
}  
