...
My testing shows 6 bytes (5 different sensor's data + device indentifier using 1 byte)  of sensor data is moved both ways within 150 microseconds on average.
